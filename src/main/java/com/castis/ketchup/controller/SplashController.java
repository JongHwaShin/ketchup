...
public class SplashController {
    ...
    @GetMapping(value = "/{APP_TYPE}/info/getVersionCheckAOS")
    public Response getVersionCheckAOS(@PathVariable("APP_TYPE") String app_type) {
        App_Management app_management = splashService.getVersionCheckAOS();
        logger.info("app_management == "+app_management);
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(new MediaType("application","json", StandardCharsets.UTF_8));

        return new Response(StatusCode.OK,"성공","os_type:"+app_management.getOs_type()+"os_version"+app_management.getOs_version());
    }
    ...
    public Response getVersionCheck(@RequestParam String os_type, @PathVariable("APP_TYPE") String app_type){
       ...
       try {
           ...
           result = new Response(StatusCode.OK, "성공", tmp_Version);
       }catch (Exception e){
